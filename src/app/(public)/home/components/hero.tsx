    ...
    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
      ...
      <motion.div
        ...
        <motion.div
          ...
          <span className="text-sm font-medium text-gray-700">Modern React Template</span>
        </motion.div>

        {/* Main Headline */}
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary-blue leading-tight">
          Build Amazing
          <span className="text-orange-500 block mt-2">Web Applications</span>
        </h1>

        {/* Subheadline */}
        <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-xl">
          A powerful React template built with Next.js, TypeScript, and Tailwind CSS.
          Perfect for building modern web applications with authentication, routing, and responsive design.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Latest React framework features</p>
            </div>
          </div>
